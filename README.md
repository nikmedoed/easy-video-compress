...
* **Drag-and-Drop GUI**: Launch the script without arguments (or with `--gui`) to open a Qt-based interface. Drop videos or use **Add Videos**; each file shows progress and an overall bar tracks all jobs.
